...
RETRIABLE_EXCEPTIONS = [
    ...
    TimeoutError, httplib2.ServerNotFoundError, # Retry after reconnect to Internet 
]
# Canditates: httplib2.ServerNotFoundError
...
def upload(resource, path, body, chunksize=4*1024*1024, 
        progress_callback=None, max_retries=11):
